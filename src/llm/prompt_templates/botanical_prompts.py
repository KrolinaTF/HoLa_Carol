...
class BotanicalPrompts:
    # Prompt base para consultas médicas generales
    BASE_PROMPT = """Analiza la siguiente consulta botánica teniendo en cuenta el conocimiento
    otros factores relevantes para la salud. Proporciona una respuesta basada en evidencia:
    ...
    def get_base_prompt(query: str, context: Dict = None) -> str:
        ...
        return BotanicalPrompts.BASE_PROMPT.format(
            query=query,
            context=context_str
        )
    ...
    def get_interaction_prompt(elements: List[str], interaction_type: str) -> str:
        ...
        return BotanicalPrompts.INTERACTION_VALIDATION.format(
    ...
    def get_holistic_prompt(
        ...
        """
        return BotanicalPrompts.HOLISTIC_RECOMMENDATIONS.format(
            condition=condition,
