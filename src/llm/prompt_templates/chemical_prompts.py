...
class ChemicalPrompts:
    ...
    BASE_PROMPT = """Analiza la siguiente consulta química teniendo en cuenta el conocimiento médico, 
    ...
    def get_base_prompt(query: str, context: Dict = None) -> str:
        ...
        return ChemicalPrompts.BASE_PROMPT.format(
            query=query,
            context=context_str
        )
    ...
    def get_interaction_prompt(elements: List[str], interaction_type: str) -> str:
        ...
        return ChemicalPrompts.INTERACTION_VALIDATION.format(
    ...
    def get_holistic_prompt(
        ...
        """
        return ChemicalPrompts.HOLISTIC_RECOMMENDATIONS.format(
            condition=condition,
