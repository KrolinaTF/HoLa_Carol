...
class PhysicalPrompts:
    # Prompt base para consultas médicas generales
    BASE_PROMPT = """Analiza la siguiente consulta física teniendo en cuenta el conocimiento médico, 
    ...
    def get_base_prompt(query: str, context: Dict = None) -> str:
        ...
        return PhysicalPrompts.BASE_PROMPT.format(
            query=query,
            context=context_str
        )
    ...
    def get_interaction_prompt(elements: List[str], interaction_type: str) -> str:
        ...
        return PhysicalPrompts.INTERACTION_VALIDATION.format(
    ...
    def get_holistic_prompt(
        ...
        """
        return PhysicalPrompts.HOLISTIC_RECOMMENDATIONS.format(
            condition=condition,
